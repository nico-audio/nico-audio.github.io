...
<div class="row">
    ...
    <div class="card h-100" style="background-color: #313134;">
      <a href="">
        <img class="card-img-top" src="assets/img/lyredelay_vst_august2026.png" alt="Lyre VST Plugin">
      </a>
      <div class="card-body">
        <h4 class="card-title">
      ...
      <div class="card-footer d-flex justify-content-between align-items-center">
        <div>
          ...
          <span class="badge badge-secondary">JUCE</span>
          <span class="badge badge-secondary">VST Plugin</span>
        </div>
        <div>
          <a href="https://github.com/nico-audio/LyreDelayVST" target="_blank" rel="noopener" aria-label="github" class="text-muted">
